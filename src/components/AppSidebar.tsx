import { Shirt, Sparkles, BarChart2, TrendingUp, LogOut } from "lucide-react";
                  ...
                  return (
                    <Link key={item.to} to={item.to}
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-[15px] font-medium transition-all ${
                        active ? 'bg-sidebar-accent text-white border-l-2 border-sidebar-primary' : 'text-white/75 hover:text-white hover:bg-sidebar-accent/50'
                      }`}>
